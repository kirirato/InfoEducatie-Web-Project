<?php
	...
	function add_comment($reply, $code, $file_id) {
		echo '<form action="socio-culturale_reply.php" method="post" enctpye="" name="new_comment">'
	...
	function new_comment($file_id) {
		echo '<form action="socio-culturale_new.php" method="post" enctpye="" name="new_comment">'
			.'<input type="hidden" name="file_id" value="'.$file_id.'" />'
